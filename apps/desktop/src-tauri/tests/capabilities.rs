...
fn settings_capability_exposes_status_character_and_audio_control() {
    ...
    assert_eq!(
        ...
        [
            ...
            "allow-get-memory-content",
            "allow-update-memory",
            "allow-export-memories-csv",
            "allow-import-memories-csv",
            "allow-set-memory-domain-control",
            "allow-set-temporary-conversation",
            "allow-delete-memory",
            "allow-create-commitment",
            "allow-update-commitment",
            "allow-delete-commitment",
            "allow-get-retention-settings",
            "allow-set-retention-settings",
            "allow-get-self-review",
            "allow-regenerate-self-review",
            ...
            "allow-get-irodori-install-state",
            "allow-install-irodori",
