...
#[ts(rename_all = "snake_case", export_to = "ConversationStateDto.ts")]
...
mod tests {
    ...
    #[test]
    fn maps_domain_state_without_exposing_domain_types() {
        assert_eq!(
            ConversationStateDto::from(ConversationState::SttUnavailable),
            ConversationStateDto::SttUnavailable,
        );
    }
}
